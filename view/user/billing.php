                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="dashboard-nav">
                            <ul class="list-inline">
                                <li class="list-inline-item"><a href="index.php/user/billing" class="active">Informations de facturation</a>
                            </ul>
                        </div>
                        <!-- Dashboard-Nav  End-->
                    </div>
                        ...
                        <div class="deliver-info-form">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form__div">
                                            ...
                                            " value="<?php echo $data['nom'];?>" required readonly>
                                            <label for="" class="form__label">Nom</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form__div">
                                            <input type="text" class="form__input" value="<?php echo $data['prenom'];?>" placeholder="
                                            " required readonly>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form__div">
                                            <input type="text" class="form__input" value="<?php echo $data['adress'];?>" placeholder="
                                            " required readonly>
                                            <label for="" class="form__label">Adresse</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form__div mb-0">
                                            <input type="text" class="form__input" value="<?php echo $data['ville'];?>" placeholder="
                                            " required readonly>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form__div">
                                            <input type="text" class="form__input" value="<?php echo $data['tele'];?>" placeholder="
                                            " required readonly>
                                            <label for="" class="form__label">N Telephone</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form__div">
                                            <input type="email" class="form__input" value="<?php echo $data['mail'];?>" placeholder="
                                            " required readonly> 
                                ...
                                <div class="row">
                                    <div
                                        ...
                                        <a href="index.php/user/cart">
                                            ...
                                            Return to cart</a>
                                        <a href="index.php/user/payer" class="btn bg-primary mt-0">Continue</a>
                                    </div>
                                </div>
                                <?php } ?>
                            </form>
                        ...
                        <div class="card-price">
                            ...
                            <div class="card-price-subtotal d-flex justify-content-between align-items-center">
                                ...
                                <div class="total-price">
                                    <p>$<?php if(isset($_SESSION['sum'])) echo $_SESSION['sum'];?></p>
                                </div>
