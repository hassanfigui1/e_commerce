                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="dashboard-nav">
                            <ul class="list-inline">
                                <li class="list-inline-item"><a href="index.php/user/billing">Vos Informations</a>
                                    
                                <li class="list-inline-item"><a href="index.php/user/payer" class="mr-0 active">Paiement</a></li>
                            </ul>
                        </div>
                                ...
                                <div class="shipping-info mod">
                                    <div class="shipping-info-text">
                                        ...
                                        <div class="right mar-5">
                                            <p><?php echo $data['adress'];?> </p>
                                            <p><?php echo $data['ville'];?></p>
                                        </div>
                                    </div>
                                    
                                </div>
                                <div class="shipping-info-button">
                                        <form action="index.php/user/parametre">
                    ...
                    <div class="col-lg-5 order-1 order-lg-2">
                        <div class="card-price">
                            ...
                            <div class="card-price-subtotal d-flex justify-content-between align-items-center">
                                ...
                                $<span id="total_price"><?php if(isset($_SESSION['sum'])) echo $_SESSION['sum'];?></span>
                                </div>

                            </div>
                            <div id='paypal_payement_button'>
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="payment-area-payment">
                            <form action="#">
                                <legend class="text-center">Paiement express</legend>
                                ...
                                <div class="methods">
                                    ...
                                    <div class="methods">
                                        <div class="input">
                                            <input type="radio" name="payment-methods" id="method" checked>
                                        </div>
                                        <a href="#" class="active">
    ...
    <script src="https://www.paypal.com/sdk/js?client-id=Ae4noK9lADy8cqgaqbYLbH4OoHHGkTCLKEmv8vPztCC-2O-ivur6tW0Y35ITJOuwsEhVgqI7r8ztiJ48&disable-funding=credit,card"></script>
    <script>
    ...
    paypal.Buttons({
        ...
        onApprove:function(data,actions){
            return actions.order.capture().then(function(details){
                console.log(details)
                window.location.replace("index.php/user/traitement")
            })
        },
        onCancel:function(data){
            window.location.replace("index.php/user/payer")
        }
    }).render('#paypal_payement_button');</script>
